"""Entry point for cross-subject experiment."""
...
from cross_subject import cross_validate_model
...
def main():
    ...
    base_path = "Result_metrics/cross"
    ...
    if model_type == "2D-CNN":
        ...
        metrics = cross_validate_model(all_data, None, all_labels, device, model_type=model_type, isZscore=False, isMixture=False)
    else:
        ...
        metrics = cross_validate_model(all_eeg_data, all_emg_data, all_labels, device, model_type=model_type, isZscore=False, isMixture=False)
